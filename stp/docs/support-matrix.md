...
| Q.704 SNMM and full link management over M2PA | Partial | Q.704 heading codec, M2PA TFP/TFR/TFA/TFC/UPU route-state ingestion, COO/XCO/CBD acknowledgement, and XCO retrieval/reroute of unacknowledged user MSUs are tested; no complete emergency changeover/changeback, inhibit/uninhibit, forced reroute, or route-set-test state machines |
