...
| Q.704 SNMM and full link management over M2PA | Partial | Q.704 heading codec, M2PA TFP/TFR/TFA/TFC/UPU route-state ingestion, COO/XCO/CBD acknowledgement, XCO retrieval/reroute of unacknowledged user MSUs, and CBD/CBA restoration to normal route selection are tested; no complete emergency changeover, inhibit/uninhibit, forced reroute, or route-set-test state machines |
